...
javaaddpath('F:\Dropbox\arbeit\matlab\file_exchange\28237-querymysql\lib\mysql-connector-java-5.1.6\mysql-connector-java-5.1.6-bin.jar');

%% import classes
import edu.stanford.covert.db.MySQLDatabase;

%% create database connection
db = MySQLDatabase('192.168.1.2', 'dist_comp', 'dist_comp', 'mastering');
